...
#
docker run --rm -e "CHOWNUID=${UID}" -v `pwd`:/swagger -t docker.onedata.org/swagger-codegen:2.3.1-cowboy generate -Dapis -DapiFileNameSuffix="_routes" -i ./swagger.json -l cowboy -o ./generated/cowboy
